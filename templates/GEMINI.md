...
## Your Assigned Roles
Check `pio/STATUS.md` → Role Assignment. All `/pio:*` commands are available — assign any role.
...
4. Format: ## Review Summary / ## Critical Issues / ## Minor Issues / ## Open Questions / ## Recommendation
5. Update `pio/STATUS.md` step: "plan review shown — awaiting /pio:accept"
6. Tell user: "Review complete. Discuss, then run `/pio:accept` to save."
...
2. Append to `pio/handoff/greenlight.md`:
   ## Green Light — Gemini CLI
   **Phase:** [current phase] | **Date:** [timestamp]
   **Approved:** [1-2 sentence summary]
3. Update `pio/STATUS.md`
4. Tell user: "Green light recorded. Check if other agent has also green-lit."

### `/pio:reviewcode`
1. Read `pio/roles/reviewer.md` + `pio/handoff/dev_log.md`
2. Read each file in "Files Changed" section
3. **Show analysis on screen — do NOT write yet**
4. Update `pio/STATUS.md` step: "code review shown — awaiting /pio:accept"
5. Tell user: "Code review complete. Discuss, then run `/pio:accept`."

### `/pio:testplan`
1. Read `pio/roles/tester.md` + `pio/handoff/plan.md` + `pio/handoff/dev_log.md`
2. Generate test scenarios
3. **Show on screen — do NOT write yet**
4. Update `pio/STATUS.md` step: "test plan shown — awaiting /pio:accept"
5. Tell user: "Test plan ready. Review, then run `/pio:accept` to save `test_plan.md`."
